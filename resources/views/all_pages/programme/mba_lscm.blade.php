...
@section('content')
    ...
    <div class="programme-banner">
        ...
        --}}
        <picture>
            <source media="(max-width: 767px)" srcset="{{ asset('assets/img/programmes/lodostic_mobile.jpg') }}">
            <source media="(max-width: 991px)" srcset="{{ asset('assets/img/programmes/logostick_tablet.jpg') }}">
            <img src="{{ asset('assets/img/programmes/logostic_desktop.jpg') }}" alt="Online MBA in Logistics & Supply Chain Management Banner" fetchpriority="high" decoding="async" class="w-100">
        </picture>
