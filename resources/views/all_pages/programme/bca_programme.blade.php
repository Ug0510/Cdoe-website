                    ...
                    <section class="career-paths-section px-1 px-lg-5">
                        <div class="container-fluid">
                            ...
                            <div class="career-paths-header">
                                ...
                                <p>The Online BCA programme provides students with essential technical knowledge and practical understanding of computing and digital technologies. The programme prepares learners for opportunities across software development, IT services, business technology, and digital transformation industries. <br> Here are some popular career paths after completing an Online BCA:
                                </p>
                            </div>
                            ...
                            <div class="career-paths-content">
                                ...
                                <div class="career-paths-list-col">
                                    <ul class="career-path-list pl-3">
                                        ...
                                        <li class="career-path-item"><i class="fas fa-check-circle"></i> Entrepreneurship and Freelancing Opportunities</li>
                                    </ul>
                                </div>
