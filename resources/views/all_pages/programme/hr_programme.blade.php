            ...
            <div class="course-course-detaila-inner">
                ...
                <div class="course-section container" id="description-section">
                    <div class="course-details-content">
                        <p>Online MBA in Human Resources at Teerthanker Mahaveer University (TMU) is made for working professionals who want to grow their careers in human resource management. TMU's Centre for Distance and Online Education offers this programme, which blends robust academic learning with practical skills. It is flexible, so you can study while managing your job and personal life. <br> Through this programme, you will build the skills needed to manage people, make smart business decisions, and become a leader in any organisation. You’ll learn how to attract and keep the right talent, handle employee relations, and help businesses succeed in today’s fast-changing world.
                        </p>
                        <div class="row pt-4">
                            <div class="col-sm-6">
            ...
            <section class="career-paths-section px-1 px-lg-5">
                <div class="container-fluid">
                    ...
                    <div class="career-paths-header">
                        ...
                        <p>An Online MBA in Human Resources opens doors to a wide range of rewarding career opportunities in both the corporate world and public sector organisations. With businesses placing increasing value on effective people management and strategic workforce planning, HR professionals with advanced qualifications are in high demand. <br> Here are some of the most popular career paths you can pursue after earning an online MBA in HR : </p>
                    </div>
                    ...
                    <div id="faq-accordion" class="accordion-area mt-4">
                        <div class="card single-faq-inner style-header-bg">
                            ...
                            <div id="f-five" class="collapse" aria-labelledby="ff-five"
                                ...
                                <div class="card-body">
                                    An Online MBA in Human Resource Management is a two-year postgraduate degree programme designed to equip students with advanced knowledge and skills in managing people, workplace culture, talent development, and organisational behaviour—all delivered through digital platforms. Unlike traditional on-campus programs, it offers flexibility, allowing students to balance their studies with professional or personal commitments.
                                </div>
                            </div>
                        </div>
                        <div class="card single-faq-inner style-header-bg">
                            ...
                            <div id="f-six" class="collapse" aria-labelledby="ff-six"
                                data-parent="#faq-accordion">
                                <div class="card-body">
                                    The general eligibility criteria for enrolling in an Online MBA in HR programme include:
                                    <ul>
                                        <li>
                                            <strong>Educational Qualification:</strong> A bachelor’s degree from a recognised university (in any discipline). Most programs prefer a minimum of 50% aggregate marks.
                                        </li>
                                        <li>
                                            <strong>Work Experience (Optional but Preferred):</strong> While not mandatory in many cases, some institutions prefer candidates with 1–2 years of professional experience.
                                        </li>
                                        <li>
                                            <strong>Entrance Exams:</strong> Some universities may require scores from exams like CAT, MAT, GMAT, or their entrance tests. However, many online MBA programs waive these requirements.
                                        </li>
                                        <li>
                                            <strong>English Proficiency:</strong> For international students, proof of English language proficiency (TOEFL/IELTS) may be required.
                                        </li>
                                    </ul>
                                    <strong>Each institution may have specific additional requirements, so it's best to check the exact criteria of your chosen university.</strong>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card single-faq-inner style-header-bg">
                            ...
                            <div id="f-seven" class="collapse" aria-labelledby="ff-seven"
                                data-parent="#faq-accordion">
                                <div class="card-body">
                                    The typical duration of an Online MBA in HR is 2 years, structured into four semesters.
                                </div>
                            </div>
                        </div>
                        <div class="card single-faq-inner style-header-bg">
                            ...
                            <div id="f-eight" class="collapse" aria-labelledby="ff-eight"
                                data-parent="#faq-accordion">
                                <div class="card-body">
                                    The scope of an Online MBA in HRM is broad and promising. Graduates can pursue careers in various sectors, including IT, healthcare, education, finance, retail, manufacturing, and consulting. Roles span from operational to strategic, including:
                                    <ul>
                                        <li>HR Manager</li>
                                    ...
                                    <p>
                                        Moreover, HR professionals with MBA degrees are increasingly being seen as key strategic partners in business growth, innovation, and transformation. The rise of HR tech, people analytics, and global workforce strategies further expands the role of HR leaders across industries.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card single-faq-inner style-header-bg">
                            ...
                            <div id="f-eight" class="collapse" aria-labelledby="ff-eight"
                                data-parent="#faq-accordion">
                                <div class="card-body">
                                    The salary after completing an Online MBA in Human Resource Management varies depending on experience, location, and the employer's size. However, general estimates are:
                                    ...
                                    <p>
                                    With experience and upskilling (like certifications in HR analytics or labor law), these numbers can significantly increase. Online MBA graduates often find opportunities to move into leadership positions faster than those without a postgraduate qualification.
                                    </p>
                                </div>
                            </div>
                        </div>
